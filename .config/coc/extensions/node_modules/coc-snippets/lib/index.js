  ...
  async provideCompletionItems(document, position, _token, context) {
    ...
    for (let snip of snippets) {
      ...
      if (snip.regex) {
        ...
        Object.assign(item, {
          textEdit: {
            range: import_coc5.Range.create({ line: position.line, character: startCharacter - head.length }, position),
            newText: snip.prefix
          }
        });
        ...
        Object.assign(item, {
          preselect: true,
          textEdit: {
            range: import_coc5.Range.create({ line: position.line, character: startCharacter - prefix.length }, position),
            newText: snip.prefix
          }
        });
      }
